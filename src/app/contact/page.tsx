...
import { ADDRESS, COMPANY_NAME, PHONE_NUMBER, SERVICE_AREA } from '@/lib/constants';
                ...
                <div className="space-y-2">
                 ...
                 <div className="space-y-2">
                  <Label htmlFor="service">Service Needed</Label>
                   <Input id="service" placeholder="e.g., Emergency Repair, Tire Service" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="message">Message</Label>
                  <Textarea id="message" placeholder="Please describe your issue and location." />
                </div>
