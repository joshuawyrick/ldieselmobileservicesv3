    ...
    <div>
        <section className="relative h-[300px] md:h-[400px] overflow-hidden bg-background flex items-center justify-center text-center text-foreground">
             <div className="absolute inset-0 w-full h-full">
                <Image
                    src={params.slug === 'san-luis-obispo-ca' ? '/diesel-repair-service-locations-san-luis-obispo-santa-barbara-county.jpg' : params.slug === 'paso-robles-ca' ? '/mobile-diesel-mechanic-paso-robles-ca.png' : 'https://placehold.co/2070x1380.png'}
